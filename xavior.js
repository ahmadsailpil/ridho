// Klo Udah Di Kasih Free Minimal Nama Yutup RIDHO GANZ Ditaruh Yah :)
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
  ...
  goblok = fs.readFileSync('./video/ga.jpg')
                xavior.sendMessage(m.chat, { image: goblok, caption: `*Halo Bre 😁*\n\n Bot Rental Prices\n⭔ 15k Per Group ALL PAYMENT 1 Month\n\n\n\nhttps://wa.me/6283160327945 (Owner)` }, { quoted: m })
            }
            case 'subscribe':{
            smeme = fs.readFileSync('./video/bro.jpg')

xavior.sendMessage(m.chat, { video: smeme, mimetype: 'video/mp4', fileName: `subrek.mp4`, caption: `Betewe Lu Dah Janji Mau join grub\n\nJangan PHP Yah 😊\n\nMasuk:https://chat.whatsapp.com/GMv2BxudUzfJhIAwtv8Tvh`},{ quoted: m })} break
...
xavior.sendMessage(m.chat, {audio: goblok, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
 xavior.sendMessage(m.chat, {document: ana, mimetype: 'application/zip', fileName: `XaviorV2.zip`}, {quoted:m})}
            ...
            ana = fs.readFileSync('./Xavior.json')
              m.reply('*Woe Bre Minimal Subscribe Yt OHLX GT Lah*')
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                ...
                                callButton: {
                                    ...
                                    phoneNumber: 'https://wa.me/6283160327945'
                                }
                            }, {
                                quickReplyButton: {
            ...
            case 'bc': case 'broadcast': case 'bcall': {
                if (!isCreator) throw mess.owner
                if (!text) throw `Text mana?\n\nContoh : ${prefix + command} Subscribe Yt OHLX GT`
...
⭔ Url : ${anu.url}`,
           ...
           case 'tutor': {
           let yts = require("yt-search")
                let search = await yts('cari di yandex')
                let anu = search.videos[Math.floor(Math.random() * search.videos.length)]
                let buttons = [
                    {buttonId: `ytmp3 ${anu.url}`, buttonText: {displayText: '♫ Audio'}, type: 1},
                    {buttonId: `ytmp4 ${anu.url}`, buttonText: {displayText: '► Video'}, type: 1}
                ...
                let buttonMessage = {
                    image: { url: anu.thumbnail },
                    caption: `
⭔ *Title* : Tutor Buat bot Seperti Di sini> 🗿
⭔ *No Wa*: 083160327945
⭔ *Duration* : 24Hours
⭔ *Viewers* : 14M views
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
          ...
          listType: 1
            ...
            case 'okay': { m.reply('Subrek lah Yt OHLX GT')} break
            
             case 'menu': {
            anu = `Hallo Bre... 🤗\nSalken Bre, Gua *RIDHO*🤝\nGua Bot WhatsApp MD Bre..\nBot WA MD V3 Dari *RIDHO GANZ* Bre\nInfo Lanjut Dengerin VN nya Bre`
            let btn = [{
